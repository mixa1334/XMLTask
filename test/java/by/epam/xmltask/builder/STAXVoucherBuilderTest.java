...
public class STAXVoucherBuilderTest {
    ...
    public void testBuildVouchersList() throws CustomXMLException {
        VoucherBuilderFactory factory = new VoucherBuilderFactoryImpl();
        AbstractVoucherBuilder builder = factory.createBuilder(VoucherBuilder.STAX);

        String file = "src/test/resources/data/positive.xml";
        builder.buildVouchersList(file);
